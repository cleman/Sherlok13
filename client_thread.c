...
void *thread_graphique_fn()
{
    ...
    deck[0] = IMG_Load("res/SH13_0.png");
    deck[1] = IMG_Load("res/SH13_1.png");
    deck[2] = IMG_Load("res/SH13_2.png");
    deck[3] = IMG_Load("res/SH13_3.png");
    deck[4] = IMG_Load("res/SH13_4.png");
    deck[5] = IMG_Load("res/SH13_5.png");
    deck[6] = IMG_Load("res/SH13_6.png");
    deck[7] = IMG_Load("res/SH13_7.png");
    deck[8] = IMG_Load("res/SH13_8.png");
    deck[9] = IMG_Load("res/SH13_9.png");
    deck[10] = IMG_Load("res/SH13_10.png");
    deck[11] = IMG_Load("res/SH13_11.png");
    deck[12] = IMG_Load("res/SH13_12.png");

    // Chargement des objets
    objet[0] = IMG_Load("res/SH13_pipe_120x120.png");
    objet[1] = IMG_Load("res/SH13_ampoule_120x120.png");
    objet[2] = IMG_Load("res/SH13_poing_120x120.png");
    objet[3] = IMG_Load("res/SH13_couronne_120x120.png");
    objet[4] = IMG_Load("res/SH13_carnet_120x120.png");
    objet[5] = IMG_Load("res/SH13_collier_120x120.png");
    objet[6] = IMG_Load("res/SH13_oeil_120x120.png");
    objet[7] = IMG_Load("res/SH13_crane_120x120.png");

    // Chargerment des boutons
    gobutton = IMG_Load("res/gobutton.png");
    connectbutton = IMG_Load("res/connectbutton.png");
    ...
    while (!quit_graph)
    {
        ...
        if (SDL_PollEvent(&event))
        {
            ...
            case SDL_MOUSEBUTTONDOWN:   // Clic de la souris
                ...
                else if ((mx >= 500) && (mx < 700) && (my >= 350) && (my < 450) && (myTurn == 1)&& !quit)    // Bouton go
                {
                    ...
                    if (guiltSel != -1)
                    {
                        sprintf(sendBuffer, "G %d %d", myId, guiltSel);

                        isWantSend = 1;
                    }
                    else if ((objetSel != -1) && (joueurSel == -1))
                    {
                        sprintf(sendBuffer, "O %d %d", myId, objetSel);

                        isWantSend = 1;
                    }
                    else if ((objetSel != -1) && (joueurSel != -1))
                    {
                        sprintf(sendBuffer, "S %d %d %d", myId, joueurSel, objetSel);
        ...
        if (myDeck[0] != -1)
        {
            ...
            SDL_RenderCopy(renderer, texture_deck[myDeck[0]], NULL, &dstrect);
        }
        if (myDeck[1] != -1)
        {
            SDL_Rect dstrect = {750, 200, 1000 / 4, 660 / 4};
            SDL_RenderCopy(renderer, texture_deck[myDeck[1]], NULL, &dstrect);
        }
        if (myDeck[2] != -1)
        {
            SDL_Rect dstrect = {750, 400, 1000 / 4, 660 / 4};
            SDL_RenderCopy(renderer, texture_deck[myDeck[2]], NULL, &dstrect);
        }
